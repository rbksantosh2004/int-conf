...
! function(t) {
    ...
    t.fn.magician = function(n) {
        var a, u, r, i, o, s, c, f, h, M, l, I = t.extend({
            ...
            p = function() {
                r = a.height() - (I.offsetTop + I.offsetBottom), i = a.scrollTop() + I.offsetTop, o = i + r, s = u.outerHeight(), c = u.offset().top, f = c + s, 1 == (c <= o && f >= i) ? l = i - c + r : (c <= o && (l = r + s), f >= i && (l = 0)), l = Math.floor(l / (r + s) * 1e3), t({
                    n: M
                }).animate({
                    n: l
                }, {
        ...
        return this.each(function() {
            switch (u = t(this), a = "object" == typeof I.container ? I.container : u.parents(I.container).eq(0), I.type) {
                case "scroll":
                    ...
                    h = anime(n), p(), a.on("scroll.magicianscrolleffect" + I.uniqueKey, p);
                    break;
                case "mousemove":
        ...
        easeInBack: function(e, t, n, a, u, r) {
            return null == r && (r = 1.70158), a * (t /= u) * t * ((r + 1) * t - r) + n
        },
        easeOutBack: function(e, t, n, a, u, r) {
            return null == r && (r = 1.70158), a * ((t = t / u - 1) * t * ((r + 1) * t + r) + 1) + n
        },
        easeInOutBack: function(e, t, n, a, u, r) {
            return null == r && (r = 1.70158), (t /= u / 2) < 1 ? a / 2 * (t * t * ((1 + (r *= 1.525)) * t - r)) + n : a / 2 * ((t -= 2) * t * ((1 + (r *= 1.525)) * t + r) + 2) + n
        },
