/*! This file is auto-generated */ ! function() {
    var e = {
            1919: function(e) {
                ...
                function c(e, r, s) {
                    ...
                    return i === Array.isArray(e) ? i ? s.arrayMerge(e, r, s) : u(e, r, s) : n(r, s)
                }
                c.all = function(e, t) {
            ...
            2167: function(e) {
                ...
                function n(e, t) {
                    ...
                    for (var s = Object.keys(t).sort(), i = Array.isArray(t) ? n : o, u = 0; u < s.length; u++) {
                        var c = s[u];
                ...
                var o = function() {
                    ...
                    return o = e, s = [{
                        ...
                        value: function(r, n) {
                            ...
                            for (var o = Object.keys(r).sort(), s = [r, n], i = Array.isArray(r) ? this._arrayTreeMap : this._objectTreeMap, u = 0; u < o.length; u++) {
                                var c = o[u];
                ...
                e.exports = function(e) {
                    ...
                    return t = function() {
                        ...
                        function(n, o) {
                            ...
                            for (s = t(e, n, o), i = r.length; i--;)
                                if (n[u = r[i]] !== s[u]) return s;
                            return n
                        }
                }
            }
    ...
    ! function() {
        "use strict";
        r.r(n), r.d(n, {
            AsyncModeProvider: function() {
                return Ke
            },
            RegistryConsumer: function() {
                return Ue
            },
            ...
            createRegistryControl: function() {
                return T
            },
            createRegistrySelector: function() {
                return I
            },
            dispatch: function() {
                return et
        ...
        r.r(e), r.d(e, {
            ...
            hasResolvingSelectors: function() {
                return Z
            },
        ...
        var t = {};
        r.r(t), r.d(t, {
            failResolution: function() {
                return re
            },
            failResolutions: function() {
                return se
            },
            finishResolution: function() {
                return te
            },
            finishResolutions: function() {
                return oe
            },
            invalidateResolution: function() {
                return ie
            },
            invalidateResolutionForStore: function() {
                return ue
            },
            invalidateResolutionForStoreSelector: function() {
                return ce
            },
            startResolution: function() {
                return ee
            },
            startResolutions: function() {
                return ne
            }
        });
        var o = {};
        ...
        function S(e, t, r) {
            var n;
            if ("function" == typeof t && "function" == typeof r || "function" == typeof r && "function" == typeof arguments[3]) throw new Error(g(0));
        ...
        function O() {
            ...
            return function(e) {
                return function() {
                    ...
                    return n = h.apply(void 0, s)(r.dispatch), p(p({}, r), {}, {
                        dispatch: n
                    })
                }
            }
        ...
        var m = r(2167),
            w = r.n(m),
            R = window.wp.reduxRoutine,
            E = r.n(R),
            _ = window.wp.compose;

        function I(e) {
            const t = (...r) => e(t.registry.select)(...r);
        ...
        var F = window.wp.privateApis;
        const {
            lock: x,
            unlock: C
        } = (0, F.__dangerousOptInToUnstableAPIsOnlyForCoreModules)("I know using unstable features means my plugin or theme will inevitably break on the next WordPress release.", "@wordpress/data");
        var U = () => e => t => {
        ...
        var k = {
            ...
            instantiate(e) {
                ...
                return {
                    getSelectors() {
                        return Object.fromEntries(["getIsResolving", "hasStartedResolution", "hasFinishedResolution", "isResolving", "getCachedResolvers"].map((e => [e, t(e)])))
                    },
                    getActions() {
                        return Object.fromEntries(["startResolution", "finishResolution", "invalidateResolution", "invalidateResolutionForStore", "invalidateResolutionForStoreSelector"].map((e => [e, r(e)])))
                    },
                    subscribe() {
                        return () => () => {}
                    }
        ...
        var D = (e, t) => () => r => n => {
            const o = e.select(k).getCachedResolvers(t);
            return Object.entries(o).forEach((([r, o]) => {
                const s = e.stores ? .[t] ? .resolvers ? .[r];
                s && s.shouldInvalidate && o.forEach(((o, i) => {
                    "finished" !== o ? .status && "error" !== o ? .status || !s.shouldInvalidate(n, ...i) || e.dispatch(k).invalidateResolution(t, r, i)
                }))
            })), r(n)
        };
        ...
        const H = (K = "selectorName", e => (t = {}, r) => {
            ...
            switch (t.type) {
                ...
                case "START_RESOLUTIONS":
                    {
                        const r = new(w())(e);
                        for (const e of t.args) r.set(G(e), {
                            status: "resolving"
                        });
                        return r
                    }
        ...
        const ae = e => {
            ...
            fe = (e, t) => t instanceof Map ? Object.fromEntries(t) : t;
                ...
                c = {
                    ...
                    instantiate: c => {
                        ...
                        const f = function() {
                            ...
                            return {
                                isRunning(t, r) {
                                    return e[t] && e[t].get(ae(r))
                                },
                                clear(t, r) {
                                    e[t] && e[t].delete(ae(r))
                                },
                                markAsRunning(t, r) {
                                    e[t] || (e[t] = new(w())), e[t].set(ae(r), !0)
                                }
                            }
                        }();
                        ...
                        x(g, d);
                        const v = n.resolvers ? function(e) {
                        ...
                        const m = { ...le(e, (function(e) {
                                    const t = (...t) => {
                                        const r = l.__unstableOriginalGetState();
                                        return e(r.metadata, ...t)
                                    };
                            ...
                            R = pe(h);
                        for (const [e, t] of Object.entries(s)) R.get(t, e);
                        const I = new Proxy((() => {}), {
                                get: (e, t) => {
                                    const r = s[t];
                                    return r ? R.get(r, t) : m[t]
                                }
                            }),
                            T = new Proxy(I, {
                        ...
                        const j = function(e, t) {
                                const {
                                    ...
                                    isResolving: i,
                                    getCachedResolvers: u,
                                    getResolutionState: c,
                                    getResolutionError: a,
                                    ...l
                                } = e;
                                return le(l, ((r, n) => r.hasResolver ? (...o) => new Promise(((s, i) => {
                                    const u = () => e.hasFinishedResolution(n, o),
                                        c = t => {
                        ...
                        const P = l && (e => {
                            let t = l.__unstableOriginalGetState();
                            return l.subscribe((() => {
                                const r = l.__unstableOriginalGetState(),
                                    n = r !== t;
                                t = r, n && e()
                        ...
                        return {
                            ...
                            resolvers: v,
                            getSelectors: () => m,
                            getResolveSelectors: A,
                            getSuspendSelectors: () => N,
                            getActions: () => g,
                            subscribe: P
                        }
                    }
        ...
        function be(e = {}, t = null) {
            ...
            function i(e, n) {
                ...
                if (o.subscribe = e => {
                    ...
                    C(o.store).registerPrivateActions(C(t).privateActionsOf(e)), C(o.store).registerPrivateSelectors(C(t).privateSelectorsOf(e))
                } catch (e) {}
                return o
            }
            let u = {
                batch: function(e) {
                    n.isPaused ? e() : (n.pause(), Object.values(r).forEach((e => e.emitter.pause())), e(), n.resume(), Object.values(r).forEach((e => e.emitter.resume())))
                },
                stores: r,
                namespaces: r,
                subscribe: (e, o) => {
                ...
                register: function(e) {
                    i(e.name, (() => e.instantiate(u)))
                },
                registerGenericStore: function(e, t) {
                    c()("wp.data.registerGenericStore", {
                        since: "5.9",
                ...
                registerStore: function(e, t) {
                    ...
                    return i(e, (() => ge(e, t).instantiate(u))).store
                },
            ...
            u.register(k);
            for (const [t, r] of Object.entries(e)) u.register(ge(t, r));
            t && t.subscribe(s);
            const a = (l = u, Object.fromEntries(Object.entries(l).map((([e, t]) => "function" != typeof t ? [e, t] : [e, function() {
            ...
            return x(a, {
                privateActionsOf: e => {
                    try {
                        return C(r[e].store).privateActions
                    } catch (e) {
                        return {}
                    }
                },
                privateSelectorsOf: e => {
                    try {
                        return C(r[e].store).privateSelectors
                    } catch (e) {
                        return {}
                    }
                }
        ...
        function he(e) {
            var t, r;
            return !1 !== Se(e) && (void 0 === (t = e.constructor) || !1 !== Se(r = t.prototype) && !1 !== r.hasOwnProperty("isPrototypeOf"))
        }
        var Oe = r(1919),
            me = r.n(Oe);
        let we;
        const Re = {
            getItem(e) {
                return we && we[e] ? we[e] : null
            },
            setItem(e, t) {
                we || Re.clear(), we[e] = String(t)
            },
            clear() {
        ...
        let _e;
        try {
            _e = window.localStorage, _e.setItem("__wpDataTestLocalStorage", ""), _e.removeItem("__wpDataTestLocalStorage")
        } catch (e) {
            _e = Ee
        }
        const Ie = _e,
                ...
                registerStore(t, n) {
                    ...
                    return s.subscribe(function(e, t, n) {
                        ...
                        if (Array.isArray(n)) {
                            ...
                            s = rt(e), o = (e, t) => t.nextState === e ? e : s(e, t)
        ...
        var Ne = je,
            ...
            Pe = window.wp.priorityQueue,
            Le = window.wp.isShallowEqual,
            Me = r.n(Le);
        const Fe = (0, Ae.createContext)(ve),
            {
                Consumer: xe,
                Provider: Ce
            } = Fe,
        ...
        const Ve = (0, Ae.createContext)(!1),
            {
                Consumer: Ge,
                Provider: He
            } = Ve;
        var Ke = He;
        const We = (0, Pe.createQueue)();
            ...
            return (t, a) => {
                function l() {
                    ...
                    const a = {
                        ...
                        l = e.__unstableMarkListeningStores((() => t(r, e)), a);
                    u ? u.updateStores(a.current) : u = (t => {
                        const r = [...t],
                            o = new Set;
                        return {
                            subscribe: function(t) {
                                ...
                                function l(t) {
                                    a.push(e.subscribe(u, t))
                                }
                                for (const e of r) l(e);
                                return o.add(l), () => {
                                    o.delete(l);
                    ...
                    })(a.current), Me()(s, l) || (s = l), o = t, c = !0
                }
                return i && !a && (c = !1, We.cancel(n)), l(), i = a, {
        ...
        function Xe(e, t, r) {
            const n = De(),
                o = (0, Ae.useContext)(Ve),
                s = (0, Ae.useMemo)((() => $e(n, e)), [n]),
                i = (0, Ae.useCallback)(t, r),
                {
                    subscribe: u,
                    getValue: c
                } = s(i, o),
                a = (0, Ae.useSyncExternalStore)(u, c, c);
            return (0, Ae.useDebugValue)(a), a
        }
        ...
        function ze(e, t) {
            ...
            return r ? (o = e, De().select(o)) : Xe(!1, e, t);
            var o
        }
        ...
        var Be = e => (0, _.createHigherOrderComponent)((t => (0, _.pure)((r => {
            const n = ze(((t, n) => e(t, r, n)));
            return (0, Ae.createElement)(t, { ...r,
                ...n
            })
        }))), "withSelect");
        var Qe = (e, t) => {
        ...
        var qe = e => (0, _.createHigherOrderComponent)((t => r => {
            const n = Qe(((t, n) => e(t, r, n)), []);
            return (0, Ae.createElement)(t, { ...r,
                ...n
            })
        }), "withDispatch");
        var Ye = (0, _.createHigherOrderComponent)((e => t => (0, Ae.createElement)(Ue, null, (r => (0, Ae.createElement)(e, { ...t,
            registry: r
        })))), "withRegistry");
        var Ze = e => {
            const {
