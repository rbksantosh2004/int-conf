/*! This file is auto-generated */ ! function() {
    ...
    var t = {
        ...
        e = {};
    t.r(e), t.d(e, {
        __unstableStripHTML: function() {
            return $
        },
        computeCaretRect: function() {
            return b
        },
        documentHasSelection: function() {
            return w
        },
        documentHasTextSelection: function() {
            return N
        },
        documentHasUncollapsedSelection: function() {
            return C
        },
        focus: function() {
            return ct
        },
        getFilesFromDataTransfer: function() {
            return ut
        },
        getOffsetParent: function() {
            return O
        },
        getPhrasingContentSchema: function() {
            return tt
        },
        getRectangleFromRange: function() {
            return g
        },
        ...
        isEntirelySelected: function() {
            return A
        },
        isFormElement: function() {
            return D
        },
        isHorizontalEdge: function() {
            return x
        },
        isNumberInput: function() {
            return _
        },
        isPhrasingContent: function() {
            return et
        },
        isRTL: function() {
            return P
        ...
        isVerticalEdge: function() {
            return F
        },
        placeCaretAtHorizontalEdge: function() {
            return j
        },
        placeCaretAtVerticalEdge: function() {
            return U
        },
        remove: function() {
            return q
        },
        removeInvalidHTML: function() {
            return it
        },
        replace: function() {
            return W
    ...
    function i(t, {
        ...
        const n = t.querySelectorAll(function(t) {
            return [t ? '[tabindex]:not([tabindex^="-"])' : "[tabindex]", "a[href]", "button:not([disabled])", 'input:not([type="hidden"]):not([disabled])', "select:not([disabled])", "textarea:not([disabled])", 'iframe:not([tabindex^="-"])', "object", "embed", "area[href]", "[contenteditable]:not([contenteditable=false])"].join(",")
        }(e));
    ...
    function f(t) {
        return t.filter(c).map(a).sort(l).map(s).reduce(function() {
            const t = {};
            return function(e, n) {
                const {
                    nodeName: r,
                ...
                if ("INPUT" !== r || "radio" !== o || !u) return e.concat(n);
                const c = t.hasOwnProperty(u);
                if (!i && c) return e;
                if (c) {
                    const n = t[u];
                    e = e.filter((t => t !== n))
                }
                return t[u] = n, e.concat(n)
            }
        }(), [])
    }
    ...
    function m(t) {
        return f(i(t.ownerDocument.body)).reverse().find((e => t.compareDocumentPosition(e) & t.DOCUMENT_POSITION_PRECEDING))
    }

    function h(t) {
        return f(i(t.ownerDocument.body)).find((e => t.compareDocumentPosition(e) & t.DOCUMENT_POSITION_FOLLOWING))
    }
    ...
    function g(t) {
        if (!t.collapsed) {
            ...
            for (const {
                    ...
                    left: c,
                    right: a
                } of n) t < r && (r = t), e > o && (o = e), c < i && (i = c), a > u && (u = a);
            return new window.DOMRect(i, r, u - i, o - r)
        }
        const {
            startContainer: e
        } = t, {
    ...
    function A(t) {
        ...
        if (i === t && u === t && 0 === c && a === t.childNodes.length) return !0;
        t.lastChild;
        p();
        const s = u.nodeType === u.TEXT_NODE ? u.data.length : u.childNodes.length;
        return R(i, t, "firstChild") && R(u, t, "lastChild") && 0 === c && a === s
    }
    ...
    function L(t, e, n, r) {
        ...
        "static" === u && (r.style.position = "relative"), r.style.zIndex = "10000";
        ...
        return r.style.zIndex = o, r.style.position = i, c
    }
    ...
    function M(t, e, n = !1) {
        ...
        if (!s && d && d > l.height && a === e) return !1;
        const m = P(t) ? !e : e,
            h = t.getBoundingClientRect(),
            b = L(r, m ? h.left + 1 : h.right - 1, e ? h.top + 1 : h.bottom - 1, t);
        if (!b) return !1;
        const N = g(b);
        if (!N) return !1;
        const y = e ? "top" : "bottom",
            E = m ? "left" : "right",
            C = N[y] - f[y],
            w = N[E] - l[E],
            T = Math.abs(C) <= 1,
    ...
    t.r(r), t.d(r, {
        ...
        isTabbableIndex: function() {
            return c
        }
    });
    var I = window.wp.deprecated,
        H = t.n(I);

    function _(t) {
        return H()("wp.dom.isNumberInput", {
            since: "6.1",
            version: "6.5"
    ...
    function V(t, e, n) {
        ...
        void 0 === n ? n = e ? i.right - 1 : i.left + 1 : n <= i.left ? n = i.left + 1 : n >= i.right && (n = i.right - 1);
        return L(r, n, o ? i.bottom - 1 : i.top + 1, t)
    }
    ...
    function B(t, e, n) {
        ...
        let r = V(t, e, n);
        if (!(r && r.startContainer && t.contains(r.startContainer) || (t.scrollIntoView(e), r = r = V(t, e, n), r && r.startContainer && t.contains(r.startContainer)))) return;
        const {
            ownerDocument: o
        } = t, {
            defaultView: i
        ...
        p(), u.removeAllRanges(), u.addRange(r)
    }
    ...
    const K = {
        ...
        Q = ["#text", "br"];
    Object.keys(K).filter((t => !Q.includes(t))).forEach((t => {
        const {
            [t]: e, ...n
        } = K;
        K[t].children = n
    ...
    function tt(t) {
        ...
        const {
            ...
            ins: {
                children: Z.ins.children
            },
            del: {
                children: Z.del.children
            }
        };
        return a
    }
    ...
    function ot(t, e, n, r) {
        Array.from(t).forEach((t => {
            ...
            if (!n.hasOwnProperty(o) || n[o].isMatch && !n[o].isMatch ? .(t)) ot(t.childNodes, e, n, r), r && !et(t) && t.nextElementSibling && z(e.createElement("br"), t), k(t);
                ...
                if (t.hasChildNodes()) {
                    if ("*" === c) return;
                    if (c) a.length && !t.querySelector(a.join(",")) ? (ot(t.childNodes, e, n, r), k(t)) : t.parentNode && "BODY" === t.parentNode.nodeName && et(t) ? (ot(t.childNodes, e, n, r), Array.from(t.childNodes).some((t => !et(t))) && k(t)) : ot(t.childNodes, e, c, r);
                    else
                        for (; t.firstChild;) q(t.firstChild)
                }
            }
        }))
    }
